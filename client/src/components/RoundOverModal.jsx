  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
        <div className="bg-white border-[3px] border-black w-full max-w-lg p-6 sm:p-8 shadow-[8px_8px_0px_0px_#000000] relative text-black">
          <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-[#FFE600] border-[3px] border-black px-6 py-1 font-black text-sm uppercase tracking-wider shadow-[3px_3px_0px_0px_#000000] -rotate-1 flex items-center gap-2">
          ...
          {isLoading ? (
            <div className="py-12 text-center flex flex-col items-center justify-center gap-4">
              ...
              <div className="space-y-1">
                <h3 className="font-black text-xl uppercase">AI Sedang Menilai...</h3>
                <p className="text-sm font-semibold text-gray-700">
                  Memeriksa detail gambar tim & menyiapkan roast terpedas! 🌶️
                </p>
              </div>
            </div>
          ) : (
            <div className="mt-2 space-y-5">
              <div className="text-center">
                <span className="text-xs font-bold uppercase tracking-widest text-gray-500">Topik Ronde</span>
                <h3 className="font-black text-2xl uppercase text-black">{summaryData?.topic || 'Topik Gambar'}</h3>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="sm:col-span-1 bg-[#EB4B98] border-[3px] border-black p-3 text-center text-white shadow-[3px_3px_0px_0px_#000000]">
                  <div className="text-xs font-black uppercase text-black">Kemiripan AI</div>
                ...
                <div className="sm:col-span-2 bg-[#FFE600] border-[3px] border-black p-3 shadow-[3px_3px_0px_0px_#000000] flex flex-col justify-center">
                  <div className="text-xs font-black uppercase text-black mb-1 flex items-center gap-1">
                    <Trophy className="w-3.5 h-3.5" /> AI Roast & Komentar
                  </div>
              ...
              <div className="pt-2">
                {isLastRound ? (
                  ...
                  >
                    Lihat Hasil Akhir Galeri <ArrowRight className="w-4 h-4" />
                  </button>
                ) : (
                  <button
                    onClick={onNextRound}
