export default function PlayerAvatar({ seed, size = 'md', ringColor }) {
  ...
  return (
    <>
      <div
        className={`${sizeClass} rounded-full border-[3px] border-black bg-[#E2E8F0] overflow-hidden shadow-[4px_4px_0px_0px_#000000] hover:scale-105 transition-transform`}
